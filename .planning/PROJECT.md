...
- [x] 用户能管理订阅列表（创建/编辑/暂停/删除）— *Validated in Phase 03: subscription-signal*
- [x] 系统能按默认事件类型同步订阅 repo 的可用更新（release、tag、branch digest）— *Validated in Phase 03: subscription-signal*
- [x] 用户能在 Home/Today 页面看到自上次访问以来的高优先级信号摘要 — *Validated in Phase 03: subscription-signal*
- [x] 系统能生成 digest（12h/24h 窗口）并支持桌面通知 — *Validated in Phase 03: subscription-signal*
